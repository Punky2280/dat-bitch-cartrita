-- Enhanced chat system schema (corrected for INTEGER user IDs)
-- This creates the new chat tables compatible with existing schema
...
-- Update function for timestamps (reuse existing if available)

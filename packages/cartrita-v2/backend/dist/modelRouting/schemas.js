...
export const validateModelEntry = data =>
  validateData(
    data,
    validateModelRegistryEntry,
    'Model registry entry validation failed'
  );
export const validateCostEventData = data =>

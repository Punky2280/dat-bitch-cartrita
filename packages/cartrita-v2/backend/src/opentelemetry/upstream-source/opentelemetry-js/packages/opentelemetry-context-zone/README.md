...
This module provides _Zone Context Manager with bundled [zone-js]_ for Web applications.
...
context.with(trace.setSpan(context.active(), span1), () => {
  console.log(
    ...
    trace.getSpan(context.active()) === span1
  );
  setTimeout(() => {
    ...
    context.with(trace.setSpan(context.active(), span2), () => {
      console.log(
        ...
        trace.getSpan(context.active()) === span2
      );
      setTimeout(() => {
        console.log(
          'Current span is span2',

...
export const validateModelSelectionCriteria = ajv.compile(
  modelSelectionCriteriaSchema
);
export const validateBenchmarkConfig = ajv.compile(benchmarkConfigSchema);
export const validateSafetyPipelineConfig = ajv.compile(
  safetyPipelineConfigSchema
);
...
export const validateModelEntry = (data: unknown) =>
  validateData(
    data,
    validateModelRegistryEntry,
    'Model registry entry validation failed'
  );

export const validateCostEventData = (data: unknown) =>
  validateData(data, validateCostEvent, 'Cost event validation failed');

export const validateBudgetData = (data: unknown) =>
  validateData(
    data,
    validateBudgetTracking,
    'Budget tracking validation failed'
  );

export const validateBenchmarkData = (data: unknown) =>
  validateData(
    data,
    validateModelBenchmark,
    'Model benchmark validation failed'
  );

export const validateSelectionCriteria = (data: unknown) =>
  validateData(
    data,
    validateModelSelectionCriteria,
    'Model selection criteria validation failed'
  );

export const validateBenchmarkConfiguration = (data: unknown) =>
  validateData(
    data,
    validateBenchmarkConfig,
    'Benchmark configuration validation failed'
  );

export const validateSafetyConfig = (data: unknown) =>
  validateData(
    data,
    validateSafetyPipelineConfig,
    'Safety pipeline configuration validation failed'
  );
    ...
    try {
      ...
      res.status(400).json({
        ...
        error: {
          ...
          details: (validator as any).errors,
        },
      });
    }
  };
...
export const validateModelEntryMiddleware = createValidationMiddleware(
  validateModelRegistryEntry
);
export const validateCostEventMiddleware =
  createValidationMiddleware(validateCostEvent);
export const validateBudgetMiddleware = createValidationMiddleware(
  validateBudgetTracking
);
export const validateBenchmarkMiddleware = createValidationMiddleware(
  validateModelBenchmark
);

...
router.get('/:id', async (req, res) => {
  try {
    ...
    const template = await WorkflowTemplateService.getTemplate(templateId, req.user.id);
...
router.post('/', async (req, res) => {
  try {
    ...
    const template = await WorkflowTemplateService.createTemplate(templateData, req.user.id);
...
router.post('/:id/instantiate', async (req, res) => {
  try {
    ...
    const result = await WorkflowTemplateService.instantiateTemplate(
      templateId, variables, req.user.id
    );
...
router.post('/:id/rate', async (req, res) => {
  try {
    ...
    const result = await WorkflowTemplateService.rateTemplate(
      templateId, req.user.id, rating, review
    );

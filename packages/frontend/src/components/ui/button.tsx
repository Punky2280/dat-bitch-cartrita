...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline: 'border border-gray-600 bg-gray-800/50 text-gray-300 hover:bg-gray-700/50 hover:text-white focus:ring-blue-500',
    ...
    secondary: 'bg-gray-700/80 text-gray-200 hover:bg-gray-600/80 focus:ring-gray-500'
  };

...
const PersonalLifeOSPage: React.FC<PersonalLifeOSPageProps> = ({ token, onBack }) => {
      ...
      <header className="glass-card border-b border-gray-600/50 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gradient">Personal Life OS</h1>
              <p className="text-gray-400 mt-2">
                Manage your calendar, emails, contacts, and privacy settings in one place
              </p>
            </div>
          </div>
          <Button 
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {systemStatus.services?.services && Object.entries(systemStatus.services.services).map(([service, status]: [string, any]) => (
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{systemStatus?.services?.services ? Object.keys(systemStatus.services.services).length : 0}</span>
                  </div>
                  <div className="flex justify-between">

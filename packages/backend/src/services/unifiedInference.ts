...
import { Registry, getTaskModels, getTaskConfig, normalizeTaskName, type ProviderModel } from '../config/models.js';
...
class UnifiedInferenceService {
   ...
   */
  private async createInferencePromise(task: string, model: ProviderModel, inputs: any): Promise<any> {
   ...
   */
  private getModelsForTask(task: string, options?: UnifiedInferenceRequest['options']): ProviderModel[] {
  ...
  private cacheResult(request: UnifiedInferenceRequest, result: any, ttl: number): void {
    const cacheKey = this.generateCacheKey(request);
   ...
   */
  async chat(messages: Array<{role: string, content: string}>, options?: any): Promise<UnifiedInferenceResponse> {
  ...
  async speechToText(audioData: any, options?: any): Promise<UnifiedInferenceResponse> {
    return this.inference({
      task: 'asr',
  ...
  async generateImage(prompt: string, options?: any): Promise<UnifiedInferenceResponse> {
    return this.inference({
  ...
  async classifyImage(imageData: any, options?: any): Promise<UnifiedInferenceResponse> {
    return this.inference({
  ...
  async summarize(text: string, options?: any): Promise<UnifiedInferenceResponse> {
    return this.inference({
      task: 'nlp_classic',
      inputs: { text },
  ...
  async classify(text: string, candidateLabels: string[], options?: any): Promise<UnifiedInferenceResponse> {
    return this.inference({
      task: 'nlp_classic',
...
export function createUnifiedInferenceService(hfToken?: string): UnifiedInferenceService {
...
export { UnifiedInferenceService, type UnifiedInferenceRequest, type UnifiedInferenceResponse };
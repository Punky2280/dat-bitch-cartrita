...
export function getModelsByCapability(task: keyof typeof Registry, capability: string): ProviderModel[] {
...
export function normalizeTaskName(task: string): keyof typeof Registry {
  return (TaskAliases as any)[task] || task;
}
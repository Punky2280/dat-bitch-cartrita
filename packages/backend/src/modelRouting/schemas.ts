...
export const validateModelEntry = (data: unknown) =>
  validateData(data, validateModelRegistryEntry, 'Model registry entry validation failed');
...
export const validateBudgetData = (data: unknown) =>
  validateData(data, validateBudgetTracking, 'Budget tracking validation failed');

export const validateBenchmarkData = (data: unknown) =>
  validateData(data, validateModelBenchmark, 'Model benchmark validation failed');

export const validateSelectionCriteria = (data: unknown) =>
  validateData(data, validateModelSelectionCriteria, 'Model selection criteria validation failed');

export const validateBenchmarkConfiguration = (data: unknown) =>
  validateData(data, validateBenchmarkConfig, 'Benchmark configuration validation failed');

export const validateSafetyConfig = (data: unknown) =>
  validateData(data, validateSafetyPipelineConfig, 'Safety pipeline configuration validation failed');

// Schema validation middleware factory
export function createValidationMiddleware(validator: (data: unknown) => boolean) {

...
router.post('/upload', upload.single('file'), async (req, res) => {
    try {
        ...
        const uploadedFile = await fineTuningService.uploadFile(req.file.path, purpose);
...
router.get('/jobs/:jobId/events', async (req, res) => {
    try {
        ...
        const response = await fineTuningService.listFineTuningEvents(jobId, options);
...
router.post('/recommendations', async (req, res) => {
    try {
        ...
        const recommendations = getHyperparameterRecommendations(dataset_size, task_type);
...
router.post('/validate', async (req, res) => {
    try {
        ...
        const isValid = fineTuningService.validateTrainingData(training_data, method);

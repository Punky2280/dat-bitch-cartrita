...
export const log = {
    ...
    fatal: (message, error, context) => defaultLogger.fatal(message, error, context),
    ...
    metric: (metricName, value, labels) => defaultLogger.metric(metricName, value, labels),
    audit: (action, resource, actor, context) => defaultLogger.audit(action, resource, actor, context),
};

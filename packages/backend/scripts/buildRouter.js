...
const distFile = path.join(root, 'dist', 'router', 'HuggingFaceRouterService.js');
const srcFile = path.join(root, 'src', 'modelRouting', 'HuggingFaceRouterService.ts');

function log(msg){ console.log(`[buildRouter] ${msg}`); }

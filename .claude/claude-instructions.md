Below is an exact, production-ready CLAUDE.md (Claude Code System Prompt) combining the project constitution + advanced engineering system rules. Place this at the repository root as CLAUDE.md.

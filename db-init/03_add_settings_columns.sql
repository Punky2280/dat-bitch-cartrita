...
SET 
  ...
  updated_at = NOW()
WHERE theme IS NULL OR language IS NULL OR voice_responses IS NULL OR ambient_listening IS NULL OR sound_effects IS NULL;

-- ✅ User_settings table extended with theme, language, and audio settings